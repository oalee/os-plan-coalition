...
% The Women.Life.Freedom movement and people of Iran are facing a lot of challenges.
...
The methodology employed in this research is the open source open science approach, which is a transparent and collaborative approach to scientific research. The methodology emphasizes sharing of privacy aware data, tools, and results through open-source platforms such as Git, thereby enhancing collaboration, transparency and reproduciliy of this work.
...
To achieve this, the methodology includes the dissemination of knowledge at various levels of complexity, ranging from academic publications to online articles written in a more accessible language. This will enable a wider audience, including children, to understand the significance and implications of the research.
% The combination of open-source and open-science movements allows for a open collaborative effort in scientific research. By sharing data, documents, and progress updates using tools such as Git, true collaboration and updating of scientific works become possible. This approach represents a paradigm shift in science, allowing for the decoupling of scientific works on same ideas from their authors and enabling potential annonymous contributions even from Iran.
